                  ...
                  <div class="masthead clearfix">
                      <div class="inner">
                          ...
                          <nav class="nav nav-masthead">
                              ...
                              <a class="nav-link" href="exp.jsp">Exponentiation</a>
                              <a class="nav-link active" href="mod.jsp">Modulo</a>
                          </nav>
                      </div>
                  </div>
                  <div class="inner cover">
                      <h1 class="cover-heading">Modulo</h1>
                      <div class="myform">
                  ...
                  <% 
                      if ((request.getParameter("angka1") != null) && (request.getParameter("angka2") != null)) {
                          try {
                              ...
                              java.lang.Double result = port.mystery1(parameter1, parameter2);
                  %>          <p class="lead"><%out.print(parameter1);%> modulo <%out.print(parameter2);%> hasilnya <% out.print(result); %></p>
                  <% 
